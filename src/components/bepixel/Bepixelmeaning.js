		...
		<div className='bepixelmeaningContainer'>
			...
			<div className='bepixelmeaning_elementsContainer'>
				<div className='bepixelmeaning_elements'>
					...
					<p>
						<spand>{t('ourbrand.meaning.element-1-spand')}</spand>{' '}
						{t('ourbrand.meaning.element-1')}
					</p>
				</div>
				<div className='bepixelmeaning_elements'>
					<img src={bpg3} loading='lazy' />
					<p>
						<spand>{t('ourbrand.meaning.element-2-spand')}</spand>{' '}
						{t('ourbrand.meaning.element-2')}
					</p>
				</div>
				<div className='bepixelmeaning_elements'>
					<img src={bpg4} loading='lazy' />
					<p>
						<spand>{t('ourbrand.meaning.element-3-spand')}</spand>{' '}
						{t('ourbrand.meaning.element-3')}
					</p>
				</div>
			</div>
		</div>
