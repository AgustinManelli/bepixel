			...
			<BrandSections
				...
				page={
					<MeaningSection
						logo={logoOpen}
						title1='Semicírculo:'
						text1="Respresenta el mundo y como 'open' comunica sus ideas."
						title2='Ojos guiñando:'
						text2='Respresenta compañerismo amistad y empatía.'
						title3='Isotipo:'
						text3='En conjunto, al mostrarse una
				mitad de cara, representa la apertura a ideas y la escucha a nuestros clientes.'
						asset1={asset1}
						asset2={asset2}
						asset3={asset3}
					/>
